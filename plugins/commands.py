...
💡 ** انا بوت اندي للخطوط الانجليزيه المحترفه فقط**

`استطيع مساعدتك في زخرفه النصوص الى زخارفه فقط ارسل النص وشاهد السحر.`
...
"""
    ...
    buttons = [
        [
            InlineKeyboardButton('مطوري', url=f"https://t.me/IIlAndylII")
        ]
    ]
    await m.reply_text(
        text=text,
